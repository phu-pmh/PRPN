...
def test(model, corpus, dictionary, cuda, mode='test', prt=False):
    model.eval()
...
if __name__ == '__main__':
    ...
    parser.add_argument('--train_corpus', type=str, default='the corpus used for training',
                        help='location of the ptb data corpus')
    parser.add_argument('--checkpoint', type=str, default='model/model_UP.pt',
                        help='model checkpoint to use')
    parser.add_argument('--mode', type=str, default='test',
                        help='train/valid/test mode')
    ...
    if args.train_corpus.rsplit('/',1) == 'penn':
        import data
        corpus_tmp = data.Corpus(args.train_corpus)
        dictionary = corpus_tmp.dictionary
    elif args.train_corpus.rsplit('/',1) == 'nli':
    ...
    test(model, corpus, dictionary, args.cuda, mode=args.mode, prt=True)