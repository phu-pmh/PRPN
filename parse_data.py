...
parser.add_argument('--data_type', type=str, help="For Mikolov's ptb, use penn. for original ptb, use ptb. For nli, use nli")
...
if args.data_type == 'penn':
    import data
elif args.data_type == 'ptb':
    import data_ptb as data
